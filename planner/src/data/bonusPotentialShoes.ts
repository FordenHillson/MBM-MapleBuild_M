...
/** Shoes Bonus Potential ranks — Nexon table 6444. */
export const BONUS_POTENTIAL_SHOES_RANKS: PotentialGrade[] = [
  'Legendary',
  'Unique',
  'Epic',
  'Rare',
...
/** Shoes Bonus Potential — Nexon table 6444. */
export const BONUS_POTENTIAL_SHOES_OPTIONS: PotentialOptionDef[] = [
  {
    id: 'phyDef',
    label: 'PHY DEF',
    isPercent: false,
  ...
  },
  {
    ...
    ...pools(
      [6.1,7.1,8.1,9],
      [0.6,0.8,1,1.2,1.3,1.9,2.5,3,3.1,3.7,4.3,4.8,6.1,7.1,8.1,9],
      [3.1,3.7,4.3,4.8],
      [0.6,0.8,1,1.2,1.3,1.9,2.5,3,3.1,3.7,4.3,4.8],
      [1.3,1.9,2.5,3],
      [0.6,0.8,1,1.2,1.3,1.9,2.5,3],
      [0.6,0.8,1,1.2],
      [0.6,0.8,1,1.2],
    ),
  },
