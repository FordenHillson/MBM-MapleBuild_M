...
/** Outfit Bottom Bonus Potential ranks — Nexon table 6442. */
export const BONUS_POTENTIAL_OUTFIT_BOTTOM_RANKS: PotentialGrade[] = [
  'Legendary',
  'Unique',
  'Epic',
  'Rare',
...
/** Outfit Bottom Bonus Potential — Nexon table 6442. */
export const BONUS_POTENTIAL_OUTFIT_BOTTOM_OPTIONS: PotentialOptionDef[] = [
  {
    id: 'phyDefPercent',
